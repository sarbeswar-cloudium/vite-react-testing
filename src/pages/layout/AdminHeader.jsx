...
function AdminHeader() {
    ...
    return (
        ...
        <div className="hidden lg:flex lg:gap-x-12">
            <Link to="/dashboard" className="text-sm/6 font-semibold text-gray-900">Dashboard</Link>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" onClick={handleLogout} className="text-sm/6 font-semibold text-gray-900">Log Out <span aria-hidden="true">&rarr;</span></a>
        </div>
        </nav>
